...
// load local configuration and Cloudant service credentials
var configLocal;
try {
  configLocal = require('./config/cloudant.json');
  console.log("Loaded local config", configLocal);
} catch (e) { }

const appEnvOpts = configLocal ? { vcap: configLocal} : {}
